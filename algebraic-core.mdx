...
This page describes the formal command model that powers dappTerminal's CLI. It is intentionally focused on the algebraic core of how different commands and protocols are managed, and how it maps to implementation and tooling.
...
- **Fuzzy resolver (ρ\_f):** Levenshtein-based matching for input typos
